...
/***/ 12:
/*!***************************************************************!*\
  !*** D:/v工作/项目/小程序/2020通用小程序/trunk/qp20200612/store/index.js ***!
  \***************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
new _vuex.default.Store({
  ...
  mutations: { //计算属性 同步 commit
    parseTime: function parseTime(state, str) {
      if (str) {
    ...
    setProjectSign: function setProjectSign(state, provinceCode) {//根据省区编码 确定接口 appid等
  ...
  actions: { //异步方法 dispatch
    ...
    getXcxOpenid: function getXcxOpenid() {var _this = this; //获取小程序openid
      return new Promise(function (resolve, reject) {
        ...
        then(function (res) {var _res = _slicedToArray(
          ...
          if (r) {
                ...
                if (res.errCode == 0) {
                  ...
                  uni.login().then(function (res) {
                    if (res) {var _res2 = _slicedToArray(
                      res, 2),_e2 = _res2[0],_r = _res2[1];
                      if (_r) {
                        uni.request({
                          url: "".concat(_this.state.isOnline ? _this.state.online.sgUrl : _this.state.test.sgUrl, "/api/getOpenid"),
                          method: 'POST',
                          data: {
                            code: _r.code,
                            provinceCode: 'all' },
            ...
            uni.login().then(function (res) {
              if (res) {var _res3 = _slicedToArray(
                res, 2),_e3 = _res3[0],_r2 = _res3[1];
                if (_r2) {
                  uni.request({
                    url: "".concat(_this.state.isOnline ? _this.state.online.sgUrl : _this.state.test.sgUrl, "/api/getOpenid"),
                    method: 'POST',
    ...
    getProvinceCode: function getProvinceCode(store, xcxOpenid) {var _this2 = this; //获取省区编号
      return new Promise(function (resolve, reject) {
        uni.getStorage({
          key: 'provinceCode' }).
        then(function (res) {var _res4 = _slicedToArray(
          ...
          if (r) {
            ...
            uni.request({
              url: "".concat(_this2.state.isOnline ? _this2.state.online.sgUrl : _this2.state.test.sgUrl, "/api/queryProvinceCode"),
              method: 'GET',
              data: {
                xcxopenid: xcxOpenid },
    ...
    getVjfOpenid: function getVjfOpenid() {
      return uni.getStorage({
        key: 'vjfOpenid' });
    ...
    getIdcardValidateCode: function getIdcardValidateCode(state, idds) {
...
/***/ 13:
/*!****************************************************************!*\
  !*** D:/v工作/项目/小程序/2020通用小程序/trunk/qp20200612/filter/index.js ***!
  \****************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 192:
/*!************************************************************************************************!*\
  !*** D:/v工作/项目/小程序/2020通用小程序/trunk/qp20200612/components/simple-address/city-data/province.js ***!
  \************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 193:
/*!********************************************************************************************!*\
  !*** D:/v工作/项目/小程序/2020通用小程序/trunk/qp20200612/components/simple-address/city-data/city.js ***!
  \********************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 194:
/*!********************************************************************************************!*\
  !*** D:/v工作/项目/小程序/2020通用小程序/trunk/qp20200612/components/simple-address/city-data/area.js ***!
  \********************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 4:
/*!***********************************************************!*\
  !*** D:/v工作/项目/小程序/2020通用小程序/trunk/qp20200612/pages.json ***!
  \***********************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/***/ 71:
/*!***************************************************************!*\
  !*** D:/v工作/项目/小程序/2020通用小程序/trunk/qp20200612/utils/utils.js ***!
  \***************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/***/ 80:
/*!*****************************************************************!*\
  !*** D:/v工作/项目/小程序/2020通用小程序/trunk/qp20200612/config/config.js ***!
  \*****************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var config = {
  imgUrl: 'https://xcxsite.vjifen.com/v/static/qp2020' };var _default =
